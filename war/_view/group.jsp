	...
	<div id="page" class="page">
		...
		<header class="item header margin-top-0 header10" id="header10">
			...
			<div class="wrapper">
				...
				<nav role="navigation"
					class="navbar navbar-purple navbar-embossed navbar-lg navbar-fixed-top">
					...
					<div class="container">
						...
						<div class="navbar-header">
							...
							<a href="home" class="navbar-brand brand"><img
								src="images/TransparentWhite.png" id="logo"></a>
						</div>
						<!--/.navbar-header -->
						...
						<form class="search-collapse"
							...
							<input type="text" id="searchText" name="keyword"
								...
								src="images/search.png" value="Search" id="searchButton">
						</form>
						<br>
				...
				<div class="pageContent">
					...
					<div class="pageInfo">
						...
						<div id="pageLinks">
							<a href="#">${group.memberCount} Members</a> | <a onclick="on()">Description</a>
							| <form action="${pageContext.servletContext.contextPath}/group" method="post">
							<input type="Submit" value="Join Group" name="memberSubmit" class="joinGroup" >
						</form>
						</div>
					</div>
					...
					<div class="sidebar">
						...
						<div id="sideBar" style="right: -300px;">
							<ul class="list-unstyled">
								<li class="sidebarItem"><a href="http://localhost:8081/Jamii/createGroup" style="color: white">Create New Group</a></li>
